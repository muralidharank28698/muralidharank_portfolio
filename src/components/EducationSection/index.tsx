...
export default function Education() {
  ...
  return (
    <section id="education" className="pt-20 text-center">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        ...
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight text-center">
          Career <span className="text-[#57d5ff]">Journey</span>
          <hr className="w-16 h-1 my-4 bg-[#57d5ff] border-0 mx-auto" />{" "}
        </h1>

        <p className="mb-10 max-w-2xl mx-auto text-normal">
  ...
  rounded-[30px] cursor-pointer group overflow-hidden 
  border border-neutral-200/80 dark:border-neutral-700/40 
  transition-colors transition-shadow duration-300 
  hover:border-neutral-200 dark:hover:border-neutral-700 
  hover:shadow-sm hover:shadow-neutral-200/50 dark:hover:shadow-neutral-800/50"
              >
